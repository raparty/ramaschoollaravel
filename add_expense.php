...
{ 
	...
	header('location:expense_manager.php?msg=1');
	
	}
	else
	{
		header('location:expense_manager.php?error=1');
	die();
	...
	<div id="content">
		<div class="grid_container">
			...
			<div class="grid_12">
					...
					<h3 style="padding-left:20px; color:#1c75bc; border-bottom:1px solid #e2e2e2;">Expense detail</h3>
