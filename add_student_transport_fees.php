...
if(isset($_POST['submit']))
{
	...
	{
		header("location:add_student_transport_fees.php?error=1");
	}
	}
	else
	{
		header("location:add_student_transport_fees.php?error=3");
	}
}
else
{
	if($_GET['msg']==1)
	{
		$msg = "<span style='color:#009900;'><h4> Student Transport Fees  Detail Added Successfully </h4></span>";
	}
	if($_GET['msg']==2)
	{
	...
	{
		$msg = "<span style='color:#FF0000;'><h4>Student Transport Fees Detail Already Exists </h4></span>";
	}
	...
	{
		$msg = "<span style='color:#FF0000;'><h4> Deposit Transport fees amount is greater than  pending amount.</h4></span>";
	}
}
