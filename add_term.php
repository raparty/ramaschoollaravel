...
if(isset($_POST['submit']))
{
	...
	//$school_logo = $_POST['school_logo'];
	 ...
	 $sql1="SELECT * FROM fees_term where term_name='".$term_name_safe."' ";
	...
	if($num==0)
	{
		...
		if($term_name_safe!="")
		{
		 $sql3="INSERT INTO fees_term(term_name) VALUES ('".$term_name_safe."')";
		$res3=db_query($sql3) or die("Error : " . db_error());
		header("Location:term_manager.php?msg=1");
		}else
		{    header("location:add_term.php?error=2");
	...
	{
		header("location: add_term.php?error=1");
	}
}
else
{
	if($_GET['msg']==1)
	{
		$msg = "<span style='color:#009900;'><h4> Term  Detail Added Successfully </h4></span>";
	}
	if($_GET['msg']==2)
	{
		$msg = "<span style='color:#009900;'><h4>Term Detail Deleted Successfully </h4></span>";
	}
	if($_GET['msg']==3)
	{
		$msg = "<span style='color:#009900;'><h4> Term Detail Updated Successfully </h4></span>";
	}
								...
								<div class="form_grid_12 multiline">
                                    ...
                                    <div class="form_input">
										<div class="form_grid_5 alpha">
											<input name="term_name" type="text"/>
