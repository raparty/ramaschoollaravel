...
if(isset($_POST['submit']))
{
	...
	{
		header("Location:edit_student_fees.php?error=2&&sid=".$_GET['sid']);
	}
}
else
	{
		header("location:edit_student_fees.php?error=3&&sid=".$_GET['sid']);
	}
}

if($_GET['error']==2)
	{
		$msg = "<span style='color:#FF0000;'><h4>Fees  Detail Already Exists  </h4></span>";
	}
		...
		<div class="grid_container">
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<h3 style="padding-left:20px; color:#1c75bc">Edit student fees</h3>
