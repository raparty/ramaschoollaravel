...
<div id="container">
		...
		<div class="grid_container">
			...
			<div class="grid_12">
				<div class="widget_wrap" >
					<h3 style="padding-left:20px; color:#1c75bc">Fees Reciept Management</h3>
				
				
                	<form action="transport_fees_reciept.php" method="post" class="form_container left_label">
 ...
 <a  href="transport_fees_reciept_searchby_name.php" style="text-decoration:underline"><input type="button" name="search" value="search by name" class="btn_small btn_orange"></a>
							...
							?>
								...
								<div class="form_grid_12">
									<div class="form_input"><div class="form_grid_4 alpha">
										...
										<a href="student_transport_fees.php"><button type="button" class="btn_small btn_orange"><span>Back</span></button>
									</a>	</div>
									</div>
								</div>
								</li>
