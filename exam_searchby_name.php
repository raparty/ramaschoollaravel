	...
	<div id="content">
		<div class="grid_container">
			...
			<div class="grid_12">
               	...
               	<form action="exam_searchby_name.php" method="post" class="form_container left_label">
				...
				<div class="widget_wrap">
					...
					$class=db_fetch_array(db_query($sql1));
						...
						<td class="center">
							...
							<td class="center">
							<a class="action-icons c-add" href="exam_marks_add_student.php?registration_no=<?php echo $row_value['registration_no'];?>" original-title="select">Go</a>	
							</td>
						</tr>
