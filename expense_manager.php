					...
					$account_category=db_fetch_array(db_query($sql1));
						...
						<td class="center">
						  <?php echo $row_value['title'];?>
							...
							<td class="center">
								<span><a class="action-icons c-edit" href="edit_expense.php?sid=<?php echo $row_value[0];?>" title="Edit">Edit</a></span><span><a class="action-icons c-delete" href="delete_expense.php?sid=<?php echo $row_value[0];?>" title="delete" onClick="return checkform1()">Delete</a></span>
							</td>
						</tr>
