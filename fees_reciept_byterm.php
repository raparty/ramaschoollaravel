		...
		die();
			  ...
			  $registration_no=$_SESSION['registration_no'];
			   ...
			   $sql="SELECT * FROM school_detail";
					...
					$reciept_no='';
					 $select_fees_detail123=db_query("select * from student_fees_detail where registration_no='".$rows['registration_no']."' and session='".$_SESSION['session']."' and fees_term='".$_SESSION['fees_term']."'   order by student_fees_id	 ASC");
...
<?php 
				            ...
				            $select_fees_detail=db_query("select * from student_fees_detail where registration_no='".$rows['registration_no']."' and session='".$_SESSION['session']."' and fees_term='".$_SESSION['fees_term']."'  order by fees_term ASC");
