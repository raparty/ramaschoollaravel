...
<div id="container">
	...
	<div id="content">
		<div class="grid_container">
			...
			<div class="grid_12">
			  <h3 style="padding-left:20px; color:#1c75bc; border-bottom:1px solid #e2e2e2;">Account Income  Detail</h3>
					...
					$account_category=db_fetch_array(db_query($sql1));
						...
						<td class="center">
						  <?php echo $row_value['title'];?>
							...
							<td class="center">
								<span><a class="action-icons c-edit" href="edit_income.php?sid=<?php echo $row_value[0];?>" title="Edit">Edit</a></span><span><a class="action-icons c-delete" href="delete_income.php?sid=<?php echo $row_value[0];?>" title="delete" onClick="return checkform1()">Delete</a></span>
							</td>
						</tr>
