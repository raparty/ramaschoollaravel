	...
	<div id="content">
		<div class="grid_container">
		  ...
		  <li style=" border-bottom:1px solid #f2420a; list-style:none">
					<h3 style=" color:#1c75bc">Library management</h3></li>
...
<br>
				...
				<div class="item_block" >
					...
					<h3><a href="#">Manage book returns</a></h3>
				...
				<div class="item_block">
					...
					<h3><a href="#">library Setting </a></h3>
                ...
                <div class="item_block" >
					...
					<h3><a href="#">Search for a book here</a></h3>
            ...
            <div class="item_widget" style="width:835px;">
				...
				<div class="item_block" style="margin-left:250px;">
					<div class="icon_block green_block">
						<span class="item_icon">
						<span class="contact_sl"><a href="#">Settings</a></span>
						</span>
					</div>
					<h3><a href="#">Manage library books</a></h3>
