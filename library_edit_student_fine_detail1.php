...
if(isset($_POST['submit']))
{
	...
	{
		header("location:library_edit_student_fine_detail1.php?error=1&&sid=".$_GET['sid']);
	}
		...
		<div class="grid_container">
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<h3 style="padding-left:20px; color:#0078D4">edit student fine</h3>
							...
							?>
								...
								<div class="form_grid_12">
									<div class="form_input">
										...
										<a href="student_fine_detail1.php"><button type="button" class="btn_small btn_orange"><span>Back</span></button></a>
