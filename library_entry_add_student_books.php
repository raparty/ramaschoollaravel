...
OR <span style="color:#F00"> *</span>
                                        ...
                                        <div class="form_grid_4" style="margin-left:-25px;">
											<a  href="library_student_searchby_name.php" style="text-decoration:underline"><input type="button" name="search" value="search by name" class="btn_small btn_orange"></a>
								</div>
