            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="tel" 
                           ...
                           value="{{ old('emergency_contact', $admission->emergency_contact) }}"
                           pattern="[0-9]{10}"
                           maxlength="10"
                           placeholder="10-digit mobile number">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control @error('address') is-invalid @enderror" 
                              ...
                              rows="2"
                              maxlength="500"
                              placeholder="Student's complete address">{{ old('address', $admission->address) }}</textarea>
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('health_issues') is-invalid @enderror" 
                              ...
                              rows="3"
                              maxlength="1000"
                              placeholder="Any allergies, medical conditions, or special health requirements">{{ old('health_issues', $admission->health_issues) }}</textarea>
                    @error('health_issues')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
