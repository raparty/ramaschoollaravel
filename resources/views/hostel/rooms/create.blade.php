...
@section('title', 'New Room - School ERP')

@section('content')
<div class="mb-4">
    <h2>🚪 New Room</h2>
    <p class="text-muted">Add a new room to the hostel</p>
</div>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('floor_id') is-invalid @enderror" 
                        ...
                        @foreach($floors as $floor)
                            <option value="{{ $floor->id }}" {{ old('floor_id', $floorId) == $floor->id ? 'selected' : '' }}>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              ...
                              name="description" 
                              rows="3"
                              placeholder="Enter room description or notes">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
