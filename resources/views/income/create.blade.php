...
@section('content')
<div class="container">
    <h2><i class="bi bi-plus"></i> Add Income</h2>
    <div class="card">
        <div class="card-body">
            <form action="{{ route('income.store') }}" method="POST">
                ...
                <div class="mb-3"><label>Invoice Number</label><input type="text" class="form-control" name="invoice_number" value="{{ old('invoice_number') }}"></div>
