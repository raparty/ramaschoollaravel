...
<div class="container">
    <div class="row mb-3">
        <div class="col-md-12">
            <h2><i class="bi bi-plus-circle"></i> Add Leave Type</h2>
        </div>
    </div>
                    ...
                    <form action="{{ route('leave-types.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name') }}" required placeholder="e.g., Sick Leave, Casual Leave">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="3" placeholder="Brief description of this leave type">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('max_days') is-invalid @enderror" 
                                   id="max_days" name="max_days" value="{{ old('max_days') }}" min="1" max="365" placeholder="Leave empty for unlimited">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('requires_approval') is-invalid @enderror" type="radio" 
                                       ...
                                       {{ old('requires_approval', '1') == '1' ? 'checked' : '' }} required>
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('requires_approval') is-invalid @enderror" type="radio" 
                                       ...
                                       {{ old('requires_approval') == '0' ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save"></i> Save Leave Type
                            </button>
                        </div>
                    </form>
                </div>
