...
<div class="container">
    <div class="row mb-3">
        <div class="col-md-12">
            <h2><i class="bi bi-plus-circle"></i> Apply for Leave</h2>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('staff-leaves.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            <label class="form-label">Number of Days: <span id="days-count" class="badge bg-info">0</span></label>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('reason') is-invalid @enderror" 
                                      ...
                                      placeholder="Please provide a brief reason for your leave application">{{ old('reason') }}</textarea>
                            @error('reason')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initial calculation if values are preset (from old input)
    calculateDays();
    updateLeaveTypeInfo();
});
</script>
