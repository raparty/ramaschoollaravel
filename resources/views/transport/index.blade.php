            ...
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-muted">
                        Set up and manage transport routes with destinations and monthly costs
                    </p>
                    <a href="{{ route('transport.routes.index') }}" class="btn btn-primary">
                        <i class="bi bi-arrow-right-circle"></i> Manage Routes
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center">
                    ...
                    <p class="card-text text-muted">
                        Manage school vehicles including buses, vans, and their capacities
                    </p>
                    <a href="{{ route('transport.vehicles.index') }}" class="btn btn-primary">
                        <i class="bi bi-arrow-right-circle"></i> Manage Vehicles
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 hover-shadow">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title">Student Transport</h5>
                    <p class="card-text text-muted">
                        Assign students to transport routes and vehicles for the academic session
                    </p>
                    <a href="{{ route('transport.students.index') }}" class="btn btn-primary">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-4">
                            <div class="p-3">
                                ...
                                <p class="text-muted mb-0">Students Using Transport</p>
                            </div>
                        </div>
                    </div>
                </div>
