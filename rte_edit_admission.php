...
{ 
   ...
   $dob=date('d-m-Y',strtotime(implode("-",$_POST['dob'])));
	...
	{ 
	header('location:rte_edit_admission.php?error=2&&student_id='.$_GET['student_id']);
     ...
     <!-------------------------------------------------------------------------------------------------------------------->
								...
								<div class="form_grid_12">
									<div class="form_input">
										...
										<button type="submit"  name="submit" class="btn_small btn_blue"><span>Save </span></button> <a href="rte_student_detail.php"><button type="button"  name="submit" class="btn_small btn_blue"><span>Back </span></button></a>
