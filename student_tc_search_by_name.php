...
<?php include_once("includes/footer.php");?><?php include_once("includes/header.php");?>
    <div class="page_title">
	<!--	<span class="title_icon"><span class="computer_imac"></span></span>
		<h3>Dashboard</h3>-->
		<div class="top_search">
				...
				<div class="widget_wrap">
					...
					$class=mysql_fetch_array(mysql_query($sql1));
						...
						<td class="center">
							...
							<td class="center">
							<a class="action-icons c-add" href="student_fine_detail1.php?registration_no=<?php echo $row_value['registration_no'];?>" original-title="select">Go</a>	
							</td>
						</tr>
