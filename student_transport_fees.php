...
<form action="transport_fees_result.php" method="post" class="form_container left_label">
				...
				<div class="widget_wrap">
					...
					$class=db_fetch_array(db_query($sql1));
						...
						<tr>
							...
							<td class="center">
							<span><a class="action-icons c-add" href="transport_fees_reciept.php?registration_no=<?php echo $student_info['registration_no'];?>" original-title="View Reciept">Reciept</a></span>	<span><a class="action-icons c-edit" href="edit_student_transport_fees.php?sid=<?php echo $row[0]; ?>" title="Edit">Edit</a></span><span><a class="action-icons c-delete" href="delete_student_transport_fees.php?sid=<?php echo $row[0]; ?>" title="delete" onClick="return checkform1()">Delete</a></span>
							</td>
						</tr>
