...
color:#ffffff;
 ...
 <?php
    ...
    if( $_SESSION['fees_term']=="all")
	{
		...
		header('location:transport_fees_reciept.php?registration_no='.$_SESSION['registration_no'].'&&fees_term='.$_SESSION['fees_term']);
		die();
		}
...
<td width="700" align="left" style="font-size:26px;"><?php echo ucwords($school_detail['school_name']);?>
</td>
