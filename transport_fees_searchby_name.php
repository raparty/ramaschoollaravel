	...
	<div id="content">
		<div class="grid_container">
			...
			<div class="grid_12">
               	...
               	<form action="transport_fees_searchby_name.php" method="post" class="form_container left_label">
				...
				<div class="widget_wrap">
					...
					$class=mysql_fetch_array(mysql_query($sql1));
						...
						<td class="center">
							...
							<td class="center">
							<a class="action-icons c-add" href="add_student_transport_fees.php?registration_no=<?php echo $row_value['registration_no'];?>" original-title="select">Go</a>	
							</td>
						</tr>
